  ...
  return (
    <>
      ...
      <div onClick={stopTyping} className='contact-form' style={displayContactForm ? { display: 'flex' } : { display: 'none' }}>
        ...
        <form onSubmit={submitForm} action='https://docs.google.com/forms/d/e/1FAIpQLScvNhXUR5rYJydXPbvq3gG3RGj0Irt2CZXjwLOxDYPBmoTiBw/viewform?usp=sf_link' target='dummyframe'>
